...
const int GAME_FIELD_X_START = 50;
const int GAME_FIELD_Y_START = 150;
const int GAME_FIELD_X_END = 290;
const int GAME_FIELD_Y_END = 450;
...
// Field = number denoting the field
